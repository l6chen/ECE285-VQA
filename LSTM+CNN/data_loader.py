...
def prepare_training_data(version = 2, data_dir = 'Data'):
	if version == 1:
		...
		t_q_json_file = join(data_dir, 'OpenEnded_abstract_v002_train2015_questions.json')
		t_a_json_file = join(data_dir, 'abstract_v002_train2015_annotations.json')

		v_q_json_file = join(data_dir, 'OpenEnded_abstract_v002_val2015_questions.json')
		v_a_json_file = join(data_dir, 'abstract_v002_val2015_annotations.json')
